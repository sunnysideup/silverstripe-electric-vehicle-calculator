...
this.salePriceExSalesCost(a);if(c){a=this.depreciationRate(a)/100;for(var d=c;0<d;d--)b-=b*a}return b};this.valueAtTheEndOfTheYear=function(a){var b=this.depreciationRate(a)/100;a=this.valueStartOfTheYear(a);return a-a*b};this.replacementSaving=function(a){a=this.valueStartOfTheYear("f")-this.valueAtTheEndOfTheYear("f");var b=this.valueStartOfTheYear("e")-this.valueAtTheEndOfTheYear("e");return Math.round((a+b)/2)};this.totalLoanAtStart=function(a){if("e"==a){a=this.purchasePrice(a);var b=this.salePrice("f")-
EVC.ActualData.amountOfCurrentCarAsLoan;return a-b}return EVC.ActualData.amountOfCurrentCarAsLoan};this.standardPrincipalRepaymentPerYear=function(a){var b=EVC.ActualData.principalRepaymentsPerYearPercentage/100;return this.totalLoanAtStart(a)*b};this.amountBorrowedAtStartOfTheYear=function(a){var b=c*this.standardPrincipalRepaymentPerYear(a);a=this.totalLoanAtStart(a)-b;return 0>a?0:a};this.amountBorrowedAtEndOfTheYear=function(a){a=this.amountBorrowedAtStartOfTheYear(a)-this.standardPrincipalRepaymentPerYear(a);
return 0>a?0:a};this.principalRepayment=function(a){var b=this.standardPrincipalRepaymentPerYear(a);a=this.amountBorrowedAtStartOfTheYear(a);return a>b?b:a};this.interest=function(a){for(var b=0,c=EVC.ActualData.financingCostInPercentage/100/365,d=1;366>d;d++){var k=this.amountBorrowedAtStartOfTheYear(a)-this.principalRepayment(a)/365*d;0<k&&(b+=k*c)}return b};this.cashLeftAfterSellingCar=function(a){a=this.valueAtTheEndOfTheYear(a)-this.amountBorrowedAtEndOfTheYear(a);return a-EVC.ActualData.saleCostForCarInPercentage/
100*a};this.equityImprovementAtEndOfYear=function(a){return this.cashLeftAfterSellingCar("e")-this.cashLeftAfterSellingCar("f")};this.insuranceCost=function(a){return EVC.ActualData.insuranceBaseCost+this.valueStartOfTheYear(a)/1E3*EVC.ActualData.insuranceCostPerThousand};this.licensingAndWOFCost=function(a){return"e"==a?EVC.ActualData.licenseWOFCostEVPerYear:EVC.ActualData.licenseWOFCostCVPerYear};this.actualAnnualKmsPerDay=function(a){return this.hasCar(a)?(a="e"==a?d-EVC.ActualData.daysWithContinuousTripsOver100Km*
EVC.ActualData.kilometresPerDayForLongTrips/365:d,0>a&&(a=0),a):0};this.actualAnnualKms=function(a){a=365*this.actualAnnualKmsPerDay(a);0>a&&(a=0);return a};this.fuelCost=function(a){return"e"==a?this.actualAnnualKms(a)/EVC.ActualData.fuelEfficiencyEV*EVC.ActualData.costOfElectricityPerKwH:this.actualAnnualKms(a)/EVC.ActualData.fuelEfficiencyCV*EVC.ActualData.costOfPetrolPerLitre};this.fuelCostPerWeek=function(a){return this.fuelCost(a)/52};this.maintenanceCost=function(a){return"e"==a?maintanceCost=
this.actualAnnualKms(a)/1E4*EVC.ActualData.maintenanceEVPerTenThousandKm:maintanceCost=this.actualAnnualKms(a)/1E4*EVC.ActualData.maintenanceCVPerTenThousandKm};this.tyreCost=function(a){var b=this.actualAnnualKms(a)/EVC.ActualData.averageKmsPerTyre*4;return"e"==a?b*EVC.ActualData.tyreCostEV:b*EVC.ActualData.tyreCostCV};this.repairCost=function(a){var b=this.valueStartOfTheYear(a);a=this.actualAnnualKms(a)/EVC.ActualData.repairKMDivider;var c=0,b=-1*(b-EVC.ActualData.maxCarValueForRepairs)/EVC.ActualData.valueDividerForRepairCalculation;
0<b&&(c=Math.pow(b,EVC.ActualData.exponentialGrowthFactorForRepairs)*a);return c};this.carRentalCost=function(a){return"e"==a?EVC.ActualData.daysWithContinuousTripsOver100Km*EVC.ActualData.costPerDayRentalCar:0};this.numberOfKMsWithRentalCar=function(a){return"e"==a?EVC.ActualData.daysWithContinuousTripsOver100Km*EVC.ActualData.kilometresPerDayForLongTrips:0};this.carRentaFuel=function(a){return this.numberOfKMsWithRentalCar(a)/EVC.ActualData.fuelEfficiencyRentalCar*EVC.ActualData.costOfPetrolPerLitre};
this.subsidy=function(a){if("e"==a){var b=0;0==c&&(b=EVC.ActualData.subsidyPaymentFixed);return-1*(b+EVC.ActualData.subsidyPaymentPerKM*this.actualAnnualKms(a))}return 0};this.personalContribution=function(a){return"e"==a?-1*(EVC.ActualData.personalContributionFixed+EVC.ActualData.personalContributionPerKM*this.actualAnnualKms(a)):0};this.totalUpFrontPayment=function(a){return this.setupCost(a)};this.totalFinanceCost=function(a){return this.interest(a)+this.principalRepayment(a)+this.replacementSaving(a)};
this.totalFixedCost=function(a){return this.insuranceCost(a)+this.licensingAndWOFCost(a)};this.totalOperatingCost=function(a){return this.fuelCost(a)+this.maintenanceCost(a)+this.tyreCost(a)+this.repairCost(a)};this.totalOtherCost=function(a){if("e"==a){var b=this.carRentalCost(a);this.carRentaFuel(a);var c=this.subsidy(a);a=this.personalContribution(a);return b+c+a}return 0};this.totalCombined=function(a){return parseFloat(this.totalUpFrontPayment(a))+parseFloat(this.totalFinanceCost(a))+parseFloat(this.totalFixedCost(a))+
...
populateResultTable:function(){jQuery("#ResultTableHolder table th, #ResultTableHolder table td").each(function(b,c){var d=jQuery(c).parents("tr").attr("data-fx"),a=jQuery(c).attr("data-type");d&&a&&(a=1==EVC.myData.hasCar(a)?EVC.myData[d](a):0,a=parseFloat(a),"number"===typeof a?(format=EVC.DataDescription.alternativeFormatsForFxs[d],a="undefined"==typeof format?a.formatMoney():"number"==format?a.formatNumber():"percentage"==format?a.formatPercentage():"kmPerDay"==format?a.kmPerYearFormat():a,jQuery(c).text(a)):
jQuery(c).text("error"));if(jQuery(c).hasClass("detailHeader")){if(0==jQuery(c).children().length)var e=jQuery(c).text(),e='<a href="#" class="influencerLink" onclick="return EVC.scenarios.checkInfluenceForRowEntry(this, \'myData\', \''+d+"');\">"+e+"</a>";else if(d=jQuery(c).find("a.hasInfluencersOpened").get(0))d.click(),d.click();jQuery(c).html(e)}})},populateCalculations:function(){jQuery("span.calcVal").each(function(b,c){if(EVC.isReadyToCalculate()){var d=jQuery(c).attr("data-fx"),a=EVC.scenarios[d](),
e=parseFloat(a),f=e;"fiveYearProfit"===d&&(f=Math.abs(e));d=f.formatMoney();a=0>a?'<span class="negativeNumber">'+d+"</span>":'<span class="positiveNumber">'+d+"</span>";"number"===typeof e?jQuery(c).html(a):jQuery(c).text("error");jQuery(c).parent().fadeIn()}else jQuery(c).parent().fadeOut()});jQuery(".straightFillers").each(function(b,c){var d=jQuery(c).attr("data-fx");d?(d=EVC.scenarios[d](),jQuery(c).html(d)):console.error("Could not find method on element")})},populateLinks:function(){jQuery(".saveLink").each(function(b,
c){"yes"==jQuery(c).attr("data-replace-link")&&jQuery(c).attr("data-default-href",jQuery(c).attr("href")).addClass("hideWithoutServerInteraction")});jQuery(".saveLink").click(function(b){var c=this,d="",a=jQuery(c).attr("data-replace-link");b=EVC.serverInteraction.workableLinks();if(!0!==b&&"yes"==a)alert("Could not save data ... please try again");else if(!0===b){b=!0===EVC.isChanged?prompt("Please enter a title for your calculation sheet"):"ignore";var e=EVC.serverInteraction.lockLink();if(null===
b)return EVC.debug&&console.debug("cancelled"),!1;b=encodeURIComponent(b);EVC.debug&&console.debug("running AJAX: lock link"+e+" answer"+b);jQuery.ajax({method:"GET",url:e,data:{title:b},cache:!1}).done(function(b){if("yes"==a){var e=encodeURIComponent(b);d=jQuery(c).attr("data-default-href");d=d.replace("[DECODED_LINK]",b);d=d.replace("[ENCODED_LINK]",e);jQuery(c).attr("href",d);EVC.debug&&console.debug("redirecting to: "+d)}else EVC.debug&&console.debug("no need to replace link"),d=jQuery(c).attr("href");
window.location=d;return!0}).fail(function(b,c){alert("Error in application - link data can not be saved: "+c);followLink="";a="yes";return!1})}else{if("no"==a)return EVC.debug&&console.debug("redirect without saving"),!0;alert("could not run command")}return!1})},updateLinks:function(){1==EVC.serverInteraction.workableLinks()&&1==EVC.isReadyToCalculate()?jQuery(".saveLink.hideWithoutServerInteraction").show():jQuery(".saveLink.hideWithoutServerInteraction").hide()},setupShowAndHideResultRows:function(){jQuery("a.expandRows").on("click",
function(b){b.preventDefault();jQuery(this).toggleClass("show");b=jQuery(this).parents("tr");jQuery(b).nextUntil("tr.summary").each(function(b,d){jQuery(d).toggle()});return!1})},hideStartup:function(){jQuery("#start-up-screen").hide();jQuery("#ElectricVehicleCalculator").show()},hideDetails:function(){jQuery("#ElectricVehicleCalculator").hide();jQuery("#HowMuchDoWeSave a").click(function(b){EVC.HTMLInteraction.transitionFromStartupToResults();return!1});window.setTimeout(function(){jQuery('input[name="startup-car-value"]').focus()},
300)},transitionFromStartupToResults:function(){jQuery("body").addClass("loading");var b=jQuery('input[name="startup-car-value"]').val(),b=parseFloat(b.replace(/[^0-9.]/g,"")),c=jQuery('input[name="petrol-spent-per-week"]').val(),c=parseFloat(c.replace(/[^0-9.]/g,"")),c=c/EVC.DefaultData.costOfPetrolPerLitre*EVC.DefaultData.fuelEfficiencyCV/7,d=!0;0===parseInt(c)&&(jQuery('input[name="petrol-spent-per-week"]').focus(),d=!1);0===parseInt(b)&&jQuery('input[name="startup-car-value"]').focus();d?(EVC.HTMLInteraction.setValue("CVValueToday",
b),EVC.HTMLInteraction.setValue("kmDrivenPerDay",c),jQuery("#start-up-screen").slideUp(function(){jQuery("#ElectricVehicleCalculator").slideDown(function(){window.setTimeout(function(){jQuery("#CVValueTodayField").change();jQuery("body").removeClass("loading");jQuery("#ProfitAndLoss").addClass("full-screen")},500);jQuery("#ViewDetailsNow a").click(function(a){EVC.HTMLInteraction.transitionFromResultsToDetails();return!1})})})):(alert("Please answer both questions."),jQuery("body").removeClass("loading"));
return!1},transitionFromResultsToDetails:function(){jQuery("#ViewDetailsNow").remove();jQuery("#ProfitAndLoss").removeClass("full-screen");return!1},selectFirstInput:function(){window.setTimeout(function(){jQuery("#CVValueTodayDisplay").click()},300)},makeGraphClickable:function(){jQuery("canvas").on("click",function(b){b=EVC.graphMaker.currentGraph.getPointsAtEvent(b);b=parseFloat(b[0].label.replace(/\$|,/g,""));var c=jQuery(this).attr("data-for");jQuery("#"+c+"Field").val(b).change()})},createFormFieldsFromList:function(b){var c=
"",d="";this.isTouchScreenTest()&&(d=' readonly="readonly" ');for(var a in b)if(b.hasOwnProperty(a)){var e=b[a],f=EVC.DataDescription.labels[a],g=EVC.DataDescription.desc[a],k=a+"Holder",h=a+"Field",l=a+"Display",m=a+"FieldRange",q=EVC.HTMLInteraction.getValueFromDefaultsOrSession(a,!1),t=EVC.HTMLInteraction.getValueFromDefaultsOrSession(a,!0),n=EVC.DefaultDataMinMax[a][0],p=EVC.DefaultDataMinMax[a][1],r=Math.round((p-n)/EVC.numberOfSteps*100)/100,u='step="'+r+'"',c=c+('<div id="'+k+'" class="fieldHolder '+
e+'">'),c=c+('<p id="'+a+'Modal" class="modalP"><a href="#'+k+'" class="closeModal" onclick="return EVC.HTMLInteraction.closeModal(\''+a+"');\">close</a></p>"),c=c+('<label for="'+m+'">'),c=c+("<strong onclick=\"return EVC.HTMLInteraction.showDesc('"+a+"');\">"+f+"</strong>"),c=c+('<span class="desc">'+g+"</span>"),c=c+"</label>",c=c+'<div class="middleColumn">',c=c+('<a href="#'+k+'" class="displayValue" id="'+l+'" onclick="return EVC.HTMLInteraction.showDesc(\''+a+"');\">"+t+"</a>");EVC.HTMLInteraction.hasRangeSlider&&
(c+='<input type="range" tabindex="-1" class="'+e+'" id="'+m+'" oninput="return  EVC.HTMLInteraction.showUpdatedValue(\''+a+"', this);\" onchange=\"return EVC.HTMLInteraction.setValue('"+a+'\', this);" value="'+q+'"  min="'+n+'" max="'+p+'" step="'+r+'" />');c+='<input type="number" inputmode="numeric" pattern="[0-9]*"  class="'+e+'" oninput="return  EVC.HTMLInteraction.startInput(\''+a+'\', this);" id="'+h+'" onclick="return EVC.HTMLInteraction.clickInput(\''+a+"', this);\" onfocus=\"return EVC.HTMLInteraction.inputReady('"+
a+"', this);\" onchange=\"return EVC.HTMLInteraction.setValue('"+a+'\', this);" value="'+q+'" '+d+' min="'+n+'" max="'+p+'" '+u+" />";c+="</div>";EVC.HTMLInteraction.hasGraphs&&(c+='<p class="graphShower"><a href="#'+a+'Chart" onclick="return EVC.HTMLInteraction.showGraphNow(\''+a+"')\">view influence graph \u21e3</a></p>",c+='<figure id="'+a+'Chart" class="chartHolder"><figcaption></figcaption><canvas data-for="'+a+'"></canvas></figure>');c+="</div>"}return c},getValueFromDefaultsOrSession:function(b,
c){var d=EVC.ActualData[b];return c?this.formatValue(b,d):d},formatValue:function(b,c){var d=EVC.DataDescription.keyAssumptionKeys[b];"undefined"==typeof d&&(d=EVC.DataDescription.playAroundAssumptionKeys[b],"undefined"==typeof d&&(d=EVC.DataDescription.otherAssumptionKeys[b],"undefined"==typeof d&&(d="error")));c=parseFloat(c);switch(d){case "number":c=c.formatNumber();break;case "percentage":c=c.formatPercentage();break;case "kmPerDay":c=c.kmPerYearFormat();break;default:c=c.formatMoney()}return c},
clickInput:function(b,c){jQuery(c).removeAttr("readonly");jQuery(c).focus();jQuery(c).select();return!0},inputReady:function(b,c){EVC.HTMLInteraction.showDesc(b)},showUpdatedValue:function(b,c){var d=jQuery(c).val();jQuery("#"+(b+"Field")).val(d);this.startInput(b,c)},startInput:function(b,c){jQuery("#ProfitAndLoss .calcVal").text("calculating ...");this.isTouchScreenTest()&&(jQuery("#ProfitAndLoss p.good").hide(),jQuery("#ProfitAndLoss p.warning").show())},updateInProgress:!1,setValue:function(b,
c,d){!0!==d&&(d=!1);if(this.updateInProgress)console.error("Application can not be updated right now.");else{this.updateInProgress=!0;var a=b+"Field",e=b+"FieldRange",f=b+"Display",g="#"+b+"Holder",k="#"+b+"Holder label strong",h=EVC.DefaultData[b],l="",m=!1;isNaN(c)?(m=EVC.isChanged=!0,d=jQuery(c).val(),d=parseFloat(d.replace(/\$|,/g,"")),isNaN(d)?(d=EVC.ActualData[b],isNaN(d)&&(d=h)):l=jQuery(c).attr("id")):(d&&(m=EVC.isChanged=!0),d=c);d=Math.round(100*d)/100;c=EVC.DataDescription.labels[b];d!=
h?(0<h?jQuery(k).text(c+" (default = "+this.formatValue(b,h)+")"):jQuery(k).text(c),jQuery(g).addClass("changed")):(jQuery(k).text(c),jQuery(g).removeClass("changed"));"kmDrivenPerDay"==b&&3<d/365&&(d=Math.round(d/365),l="");a!=l&&jQuery("#"+a).val(d);e!=l&&jQuery("#"+e).val(d);a=this.formatValue(b,d);jQuery("#"+f).text(a);EVC.serverInteraction.workableLinks()&&jQuery.ajax({method:"GET",url:EVC.serverInteraction.saveLink(),data:{key:b,value:d},cache:!1}).done(function(a){a&&(EVC.isLocked=!1,EVC.serverKey=
a)}).fail(function(a,b){alert("Data could not be saved: "+b)});EVC.ActualData[b]=d;if("kmDrivenPerDay"==b||"yearsBeforeSwitch"==b||"yearsAfterSwitch"==b)"kmDrivenPerDay"==b?EVC.myData.updateKmDrivenPerDay(d):"yearsBeforeSwitch"==b?EVC.myData.updateYearsBeforeSwitch(d):"yearsAfterSwitch"==b&&EVC.myData.updateYearsAfterSwitch(d);m&&this.updateScreen(b);this.updateInProgress=!1}return!1},showDesc:function(b,c){var d=jQuery("div#"+b+"Holder");jQuery(".infocus").each(function(a,b){jQuery(d).attr("id")!=
jQuery(b).attr("id")&&jQuery(b).removeClass("infocus").find("figure").hide()});jQuery(d).hasClass("infocus")||(d.addClass("infocus"),c||jQuery("html, body").animate({scrollTop:jQuery("#"+b+"Holder").offset().top-(jQuery("#ProfitAndLoss").height()+10)},500,function(){jQuery("#"+b+"Holder").find('input[type="number"]').focus()}));return!1},showGraphNow:function(b){jQuery("#"+b+"Chart").show("slow",function(){EVC.graphMaker.makeGraph(b)}).prev(".graphShower").hide();return!1},updateScreen:function(b){jQuery("body").addClass("loading");
EVC.debug&&console.debug("== UPDATING SCREEN ==");this.populateResultTable();this.populateCalculations();this.updateLinks();EVC.scenarios.checkInfluence();EVC.isReadyToCalculate()?jQuery("body").removeClass("not-ready").addClass("ready"):jQuery("body").removeClass("ready").addClass("not-ready");jQuery("#ProfitAndLoss").addClass("fixed");this.isTouchScreenTest()&&(jQuery("#ProfitAndLoss p.good").show(),jQuery("#ProfitAndLoss p.warning").hide());"undefined"!==typeof b&&EVC.graphMaker.makeGraph(b);jQuery("body").removeClass("loading")},
setMyValue:function(b,c){var d=c.value,d=parseFloat(d.replace(/\$|,/g,"")),d=this.formatValue(b,d);c.value=d},resetSession:function(){alert("to be completed")},isScrolledIntoView:function(b){b=jQuery(b);var c=jQuery(window),d=c.scrollTop(),c=d+c.height(),a=b.offset().top;return a+b.height()<=c&&a>=d},openModal:function(b,c){this.showDesc(b,!0);jQuery("body").addClass("modalMode");jQuery("#"+b+"Holder").addClass("modal");return!1},closeModal:function(b){jQuery("body").removeClass("modalMode");jQuery("#"+
b+"Holder").removeClass("modal").removeClass("infocus");return!1},inlineExpandListener:function(){jQuery(".inline-expand").on("click",function(b){b.preventDefault();b=jQuery(this).attr("href");b=b.substring(b.indexOf("#"));jQuery(b).toggle("slow");return!1})}};
...
listOfYears:function(){var b=(new Date).getFullYear()+EVC.ActualData.yearsBeforeSwitch,c=EVC.ActualData.yearsAfterSwitch,d,a,e="";for(d=0;5>d;d++)a=b+d,e+='<li><a href="#financial-years" onclick="return EVC.HTMLInteraction.setValue(\'yearsAfterSwitch\', '+d+', true);" class="'+(d===c?"current":"link")+'">'+a+"</a></li>";return e},totalCostPerYear:function(){var b=(new Date).getFullYear()+EVC.ActualData.yearsBeforeSwitch,c=EVC.ActualData.yearsAfterSwitch,d,a,e="";for(d=0;5>d;d++)a=b+d,e+='<li><a href="#financial-years" onclick="return EVC.HTMLInteraction.setValue(\'yearsAfterSwitch\', '+
d+', true);" class="'+(d===c?"current":"link")+'">'+a+"</a></li>";return e}};
...
exponentialGrowthFactorForRepairs:"Exponential unexpected repairs growth factor",valueDividerForRepairCalculation:"Inverse value unexpected value divider",depreciationRatePerYearCV:"Current Car: Depreciation rate per Year",depreciationRatePerYearEV:"Electric Car: Depreciation rate per Year",costPerDayRentalCar:"Cost per Day for Rental Car",kilometresPerDayForLongTrips:"KMs per Day for Long Trips",subsidyPaymentFixed:"Fixed Subsidy",subsidyPaymentPerKM:"KM Subsidy",personalContributionFixed:"Personal Contribution per Year",
personalContributionPerKM:"Personal Contribution per KM"},desc:{CVValueToday:"The price at which you can sell your current car today. If unsure, you can visit tradme.co.nz and search for cars of your make, model, and age.",kmDrivenPerDay:"Approximate kilometers you drive per day or per year - you can enter either.  There are many ways to work this out, but one of them is to look at Oil Change Stickers in your car which often contain a date and the overall KMs driven by the car up to that date.",daysWithContinuousTripsOver100Km:"Any trip where you drive more than 150km in one go and days that you are away on such a trip (e.g. enter seven if you drive to far away holiday destination where you will be away for a week). On these big days you will rent a car so that you can cover larger distances.",
yearsBeforeSwitch:"The number of years you will wait before you make the switch.  Zero means that you make the switch today.",yearsAfterSwitch:"See the results for the set number of years after you make the switch. For example, if you enter two here, then you will see the results for the year starting two year after you make the switch.",amountOfCurrentCarAsLoan:"How much of your current car cost have you borrowed? If you paid for your current car with money you saved up then enter 0.",minimumCostElectricVehicle:"Minimum price for an electric vehicle at the moment. Because electric cars are relatively new, there are few older models and depreciated cars, therefore a minimum price may apply.",
maximumCostElectricVehicle:"Maximum price for an electric vehicle at the moment. In general, the calculator tries to match your current car with an electric car of a similar value, but this number is limited up to the new price of an electric vehicle.",upgradeCostToGoElectric:"The additional amount you will have to pay to purchase an electric car similar to your current vehicle. Excluding the standard costs of purchasing a trade-in car.",EVValueImprovementPerYearPercentage:"The expected amount of relative cost improvements of electric vehicles as compared to conventional cars powered by oil based fuel for each year.",
setupChargeStation:"The cost of setting up a charging station at your home (or work) to charge your electric car. If your home has a garage with a plug then the cost could be zero.",saleCostForCarInPercentage:"The cost of selling a vehicle. Included are advertising costs, commissions, auction fees, government registration fees, etc... This is basically the difference between the buy and sell price of a car (i.e. the profit of the car sales person).",purchaseCostForCarInPercentage:"Any costs associated with purchasing a car that is paid by the purchaser.",
financingCostInPercentage:"Interest rate charged on car loans.  It may be a good idea to increase this a little bit to cover any finance fees that are charged by most lenders. ",principalRepaymentsPerYearPercentage:"The percentage of the value of the car (at the time of purchase) used to calculate any loan repayments.  For example, if you purchase a $10,000 vehicle and you pay $1000 per year (excluding interest) then the amount entered here is 10%.  In general, the payments should satisfy the basic requirement that a sale of the car today would ensure that the total outstanding amount of the loan can be met.",
costOfPetrolPerLitre:"Cost of oil based fuel (diesel / petrol) per litre.",costOfElectricityPerKwH:"Cost of the electricity used to charge your Electric Car, per Kilowatt Hour.  This is usuall between $0.10 and $0.40cents.  You may be able to apply a special night rate for this, if you are able to charge your car at night.",fuelEfficiencyCV:"Average number of kilometers you can drive on one litre of petrol in your current car.",fuelEfficiencyEV:"Average number of kilometers you expect to drive on one Kilowatt Hour in an electric car.",
fuelEfficiencyRentalCar:"Average number of kilometers you expect to drive on one litre of petrol for a rental car.",insuranceBaseCost:"A minimum insurance fee per year",insuranceCostPerThousand:"Additional insurance fee per year per $1000 of the total value of your car.",averageKmsPerTyre:"The average number of kilometers you expect to drive before the average tyre needs to be replaced.",tyreCostCV:"Cost per tyre for your current car.",tyreCostEV:"Cost per tyre for your electric car.  This may be slightly different from a conventional car as an electric car may use a fuel efficient type of tyre.",
licenseWOFCostCVPerYear:"The total amount of licensing and testing charges and fees for your current car, per year.",licenseWOFCostEVPerYear:"The total amount of licensing and testing charges and fees for an electric car, per year.",maintenanceCVPerTenThousandKm:"The total service cost for your current car per 10,000km.  For this, you may include the replacements of parts that are expected in older parts (e.g. Cam Belt, Radiator, etc...)",maintenanceEVPerTenThousandKm:"The total service cost for your electric car per 10,000km. ",
repairKMDivider:"A number used to divide the number of KMs per year. From there this number is used as a unexpected repair multiplier to basically ensure that the more you drive, the more unexpected repair cost you may have.  A typical value is 40,000.",maxCarValueForRepairs:"The value of the car when unexpected repairs start.  For example, if set to $5,000, unexpected repairs start once the car is worth less than $5,000.",exponentialGrowthFactorForRepairs:"This is a number between 1 and 3 that is used to exponentially increase the unexpected repair cost as the value of the car decreases.",
valueDividerForRepairCalculation:"When working out the unexpected repair cost for the car, we take the inverse value of the car relative to the maximum value at which repairs start.  Thus, for example, if the maximum value at which unexpected repairs start is $5000, then the inverse value increases from $0 to $5000 as the value of the car lowers from $5000 to $0.  The divider value entered here is used to divide this inverse value to get an idea of the unexpected repair value.",depreciationRatePerYearCV:"The value reduction per year for your current car.  For this, we do not take into account kms driven. Instead, we use a relatively high, linear depreciation rate that may be applied by insurance companies and car financing companies.",
depreciationRatePerYearEV:"The value reduction per year for your an electric car.  For this, we do not take into account kms driven. Instead, we use a relatively high, linear depreciation rate that may be applied by insurance companies and car financing companies.",costPerDayRentalCar:"How much does it cost to rent a similar vehicle per day, including a full insurance package.",kilometresPerDayForLongTrips:"What are the average number of KMs you will drive on any days that you will use a rental car?",
subsidyPaymentFixed:"Any subsidies as a percentage of the purchase cost from the government and/or your employer you will receive when purchasing an electric vehicle. This only applies at the time of purchase.  It is not a yearly payment.",subsidyPaymentPerKM:"Any per kilometer subsidies (government / employer) payments you will receive when driving an electric vehicle.",personalContributionFixed:"Any yearly personal payments or value you would like to add to the total purchase price of your electric vehicle to account for your reduced emissions. This only applies at the time of purchase.  It is not a yearly payment.",
personalContributionPerKM:"Any per kilometer, personal, payments or value you would like to add when driving an electric vehicle. This could, for example, be equal to the carbon credits you receive based on your reduced emissions."},alternativeFormatsForFxs:{actualAnnualKms:"number",actualAnnualKmsPerDay:"number",numberOfKMsWithRentalCar:"number"},headerTitles:{keyAssumptions:"your current situation",playAroundAssumptions:"play around",otherAssumptions:"tweak assumptions"}};
EVC.DefaultData={CVValueToday:0,kmDrivenPerDay:0,daysWithContinuousTripsOver100Km:0,yearsBeforeSwitch:0,yearsAfterSwitch:0,amountOfCurrentCarAsLoan:0,minimumCostElectricVehicle:18E3,maximumCostElectricVehicle:2E5,upgradeCostToGoElectric:30,EVValueImprovementPerYearPercentage:20,setupChargeStation:300,saleCostForCarInPercentage:7,purchaseCostForCarInPercentage:3,financingCostInPercentage:10,principalRepaymentsPerYearPercentage:20,costOfPetrolPerLitre:2,costOfElectricityPerKwH:.2,fuelEfficiencyCV:10,
fuelEfficiencyEV:5,fuelEfficiencyRentalCar:12,insuranceBaseCost:200,insuranceCostPerThousand:50,averageKmsPerTyre:4E4,tyreCostCV:100,tyreCostEV:100,licenseWOFCostCVPerYear:250,licenseWOFCostEVPerYear:350,maintenanceCVPerTenThousandKm:400,maintenanceEVPerTenThousandKm:50,repairKMDivider:15E3,maxCarValueForRepairs:7E3,exponentialGrowthFactorForRepairs:1.7,valueDividerForRepairCalculation:100,depreciationRatePerYearCV:27,depreciationRatePerYearEV:27,costPerDayRentalCar:70,kilometresPerDayForLongTrips:300,
