...
(EVC.HTMLInteraction.hideStartup(),EVC.HTMLInteraction.selectFirstInput())},500))},clear:function(){jQuery("#EVCWrapper").addClass("notReady");jQuery("#KeyAssupmptions").html("");jQuery("#PlayAroundAssumptions").html("");jQuery("#OtherAssumptions").html("");jQuery("tr.detail").hide();jQuery("a.expandRows").unbind("click")},isTouchScreenTest:function(){null===this.isTouchScreen&&(this.isTouchScreen="ontouchstart"in window||navigator.maxTouchPoints);return this.isTouchScreen},buildKeyAssumptionForm:function(){jQuery("#KeyAssupmptions").html("<h2>"+
